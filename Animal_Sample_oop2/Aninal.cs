...
namespace Animal_Sample_oop2
{
    ...
    class Cat : Animal
    {
        ...
        public override void say()
        {
            ...
            Console.WriteLine("meow"); //издать звук мяу
        }
    }
    ...
    class Dog : Animal
    {
        ...
        {
            Console.WriteLine($"{name} ({color}, {mass}) says:");
            Console.WriteLine("wof"); //издать звук мяу
        }
    }

    //Домашнее задание:
    //Создать классы-наследники других животных от класса Animal
    //Например жирафа и Утконоса, добавить в эти классы новый функционал и поля, проявите фантазию :)
    //
    //Успехов!
}
